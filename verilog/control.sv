...
module control (
	...
	function void addressWith(string registerName);
		if (registerName == "D") begin
			...
			Sm_en = 1;
			Spagem_en = 1;
		end else if (registerName == "PC") begin
			PCLm_en = 1;
			PCHm_en = 1;
		end
	endfunction
	...
	always @ (state, P_in, alu_N, alu_V, alu_Z, alu_C, IR_in) begin : state_actions
		...
		A_ld = 0;
		PCL_ld = 0; PCH_ld = 0;
		// These are load signals too.
		PCL_inc = 0; PCH_inc = 0;
		PCH_dec = 0;
		DL_ld = 0; DH_ld = 0;
		DL_inc = 0; DH_inc = 0;
		TL_ld = 0; TH_ld = 0; TH_inc = 0;
		P_ld = 0;
		IR_ld = 0;
		...
		Smux_sel = 0;
		Amux_sel = 0;
		ALU_Amux_sel = aluSel_A; ALU_Bmux_sel = aluSel_A;
		PCLmux_sel = 0; PCHmux_sel = 0;
		DLmux_sel = 0; DHmux_sel = 0;
		TLmux_sel = 2'b00; THmux_sel = 0;
		Pmux_sel = 0;
		IRmux_sel = 0;
		IRQLmux_sel = 0;
